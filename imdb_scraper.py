...
csv_file = open('cms_scrape_adventure.csv', 'w', newline='')
...
#Open CSV File Movie Picture NOT NECESSARY NOW
...
for x in range (0, 200):
    x = x*50 +1
    #Get a signle URL
    url_list = requests.get(f'https://www.imdb.com/search/title/?title_type=tv_series,tv_miniseries&genres=adventure&start={x}&explore=genres&ref_=adv_nxt').text
